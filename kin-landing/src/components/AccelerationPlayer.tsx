...
export function AccelerationPlayer({
    ...
    const chunkLength = calculateChunkLength(currentIndex - wordInChunk, words);
    ...
    const getCurrentDelay = useCallback(() => {
        ...
        return startDelay + (endDelay - startDelay) * progressInChunk;
    ...
    useEffect(() => {
        ...
        timeoutRef.current = setTimeout(() => {
            ...
            if (isSentenceEnd(word)) nextSentenceCount++;
    ...
    }, [currentIndex, isActive, words, getCurrentDelay, resetInterval, sentenceCount, onComplete]);
