 ...
 * Allows: hex colors, rgb/rgba, hsl/hsla, and CSS named colors.
 * Prevents CSS injection attacks via malformed color values.
 */
const isValidCssColor = (color: string): boolean => {
  ...
  // Reject anything with semicolons, curly braces, or other CSS injection patterns
  ...
  if (/^rgba?\(\s*[\d.%,\s/]+\)$/.test(trimmed)) return true;
  
  // Allow hsl/hsla with numbers, percentages, and deg
  if (/^hsla?\(\s*[\d.%,\s/deg]+\)$/.test(trimmed)) return true;
  
  // Allow CSS named colors (alphanumeric only, no special chars)
